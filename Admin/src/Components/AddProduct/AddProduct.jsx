...
const AddProduct = () => {
    ...
    const Add_Product =async()=>{
      ...
      //upload image into upload endpoint
      let responseData;
  ...
  return (
    <div className='add-product'>
      <div className="addproduct-itemfield">
        <p>Product Name</p>
        <input value={productDetails.p_name} onChange={changeHandler} type="text" name="p_name" placeholder='Type here' />
      </div>
      ...
      <div className="addproduct-itemfield">
        ...
        <select value={productDetails.category} onChange={changeHandler} name="category" id="category">
          ...
          <option value="sareecollection">Saree Collection</option>
          <option value="silkcollection">Silk Collection</option>
