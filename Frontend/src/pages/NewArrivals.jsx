  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        // Filter products by the "new-arrivals" category
        const newArrivalsProducts = response.data.filter(product => product.category === 'newarrivals');
  ...
  return (
    <section id="product1" className="max-w-screen-xl mx-4 text-center py-7 md:mx-8 lg:mx-16">
      <div className="w-full mb-8">
        <img src={cover} alt="New Arrivals Collection Cover" className="w-full h-auto rounded-lg shadow-lg" />
      </div>
